export default function Home() {
  const data = [
    ...
    {
      photo:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQrxVQS6FTAKCWpR7xX2ScDvKRmKhp6_Zo7GfutmwaG7w&s",
      name: "name3",
  ...
  return (
    <>
      {/* <Navbar /> */}
      <div className=" ">
        <div className="font-bold text-xl mb-5">Home page</div>
        <div className="mx-4 ">
          {data.length > 0 ? (
            data?.map((el, idx) => {
              return (
                <div key={idx} className="grid grid-cols-4 gap-3 mb-3">
                  <div className="col-span-1">
                    <img src={el.photo} alt="photo" className="object-fill sm:w-full" />
                  </div>
